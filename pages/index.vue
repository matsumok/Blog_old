<template>
  <div class="max-w-3xl max-w-5xlmin-h-screen flex justify-center mx-auto my-12">
    <main class="w-full">
      ...
      <section>
        <form class="flex flex-col space-y-2 mb-4">
          ...
          <input id="search-blogs" v-model="query" class="px-3 py-2 shadow border border-gray-200" type="text" />
        </form>
      </section>
